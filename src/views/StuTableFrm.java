...
public class StuTableFrm extends JFrame{		//学生用户信息界面
  ...
  public StuTableFrm() {
    ...
    jp.add(jsp_table);
    btnAdd.addActionListener(new ActionListener() {		//增加学生用户信息
        public void actionPerformed(ActionEvent e) {
        	new StuAddFrm();
        }
      });
    btnDelete.addActionListener(new ActionListener() {	//删除学生用户信息
      public void actionPerformed(ActionEvent e) {
        btnDelete_Clicked();
      }
    });
    ...
    btnAlter.addActionListener(new ActionListener() {	//查找并修改学生用户信息
        public void actionPerformed(ActionEvent e) {
			...
			{
				new StuAlterFrm(field1.getText());
			}
        }
      });
      this.setTitle("用户管理后台");
