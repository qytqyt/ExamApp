...
public class ManagerAlterFrm extends JFrame implements ActionListener {		//管理员信息修改界面
	...
	ResultSet rs = null;
	String uid;
	public ManagerAlterFrm(String number)
	{
		init();
		setVisible(true);
	...
	public void setText()//此函数功能是 把数据库 需要修改的信息 都打印到界面的文本框中
	{
		...
		try {
			...
			String sql = "select * from managers where uid = '"+uid+"';";
			...
			else
			{
				...
				if(n == JOptionPane.YES_OPTION)
				{
					...
					try {
						...
						stmt = con.createStatement();
						String str =  "update managers set uid='"+id+"',upwd='"+pwd+"',name='"+name+"',email='"+email+"',needfindpwd='"+needfindpwd+"' where uid = '"+uid+"';";
