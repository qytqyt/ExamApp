...
public class TeacherTableFrm extends JFrame{		//教师用户信息界面
  ...
  public TeacherTableFrm() {
    ...
    jp.add(jsp_table);
    btnAdd.addActionListener(new ActionListener() {		//增加教师用户信息
        public void actionPerformed(ActionEvent e) {
        	new TeacherAddFrm();
        }
      });
    btnDelete.addActionListener(new ActionListener() {	//删除教师用户信息
      public void actionPerformed(ActionEvent e) {
        btnDelete_Clicked();
      }
    });
    ...
    btnAlter.addActionListener(new ActionListener() {	//查找并修改教师用户信息
        public void actionPerformed(ActionEvent e) {
			...
			{
				dispose();
				new TeacherAlterFrm(field1.getText());
			}
        }
      });
      this.setTitle("教师用户管理后台");
