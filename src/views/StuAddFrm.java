...
import dao.StuDao;
public class StuAddFrm extends JFrame{		//学生用户信息添加界面
   ...
   private StuTableFrm stutablefrm=new StuTableFrm();
   public StuAddFrm() {
   ...
   private void btnAddClicked() {
	  ...
	  if(stuDao.addUser(uid,upwd,name,email,needfindpwd)>0) {
		  JOptionPane.showMessageDialog(this, "增加成功!");
		  stutablefrm.updateTable();
	  }else {
